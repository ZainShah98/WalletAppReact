			   ...
			   <div className="row">
			     <div className="col-md-8 m-auto">
				  ...
				  <form onSubmit={this.handleSubmit}>
					 ...
					 <div className="form-group">
					      <textarea value={description} onChange={event=>this.changeHandler(event,"description",false)} className="form-control form-control-lg"  placeholder="Descripyion"></textarea>
					 </div>
				     <div className="form-group">
					       <label htmlfor="exampleFormControlTextarea1">Transaction Type</label>
						   <div className="form-check form-check-inline">
						      <input checked className="form-check-input" type="radio" id="income" onChange={event=>this.changeHandler(event,"type",false)} value"1" />
