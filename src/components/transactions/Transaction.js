					...
					<table className="table">
					  ...
					  <tbody>
					       <tr> className="table-danger">
						        <td>2020-04-15</td>
								<td>PTCL Bill</td>
								<td> className="table-danger">-3000</td>
						        <td>
								    <a className="text-info" href="updatetransactionForm.html"><i className="fas fa-plus-circle"> </i>
								    <span className"text-danger"><i className="fas fa-trash fa-2x"></i>
								</td>
						   </tr>
